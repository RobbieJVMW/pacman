...
//console.log('connection_details: ' + connection_details);     // Logging out for debugging


var database = {
    url: `mongodb+srv://${auth_details}${connection_details}/${mongo_database}`,
    options: {
...
//console.log(database);  // Logging out for debug *warning* this will display DB credits in the console
